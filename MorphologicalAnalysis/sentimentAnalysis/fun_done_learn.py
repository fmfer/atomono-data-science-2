...
def fun_done_learn():
    dir_name = 'fun_done_learn_10_24_10_30'
    ...
    _slack = slack(generate_path(dir_name+'/中鉢PT2023 Slack export Oct 24 2023 - Oct 30 2023',''))
    results['slack'] = _slack
    return results

# [{'Content': 'もっとPRを細かく', 'Created by': 'Jabelic'}]
def retro(dir_name, file_name):
    if not 'fun,done,learn' in file_name: return
    results = []
    with open (
